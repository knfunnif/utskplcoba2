            ...
            <tbody>
                ...
                ?>
                    ...
                    <?php
                        ...
                        $tahun = $p2->tahun;
                    ?>
                        <td><?php print_r ($p2->id_keluar_proyek); ?></td>
                        <td><?php print_r ($hari." ".$bulan." ".$tahun); ?></td>
                        <td><?php print_r ($p2->proyek); ?></td>
                        <td><?php print_r ($p2->uraian); ?></td>
                        <td><?php print_r ($p2->nominal); ?></td>
                        <td><img src="/xampp/htdocs/cobain/upload/data/<?php print_r ($p2->nota); ?>" style="position: center; width: 100px; height: auto;"></td>
